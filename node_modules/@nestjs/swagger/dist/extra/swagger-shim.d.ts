...
export declare function IntersectionType(): () => void;
export declare function OmitType(): () => void;
export declare function PartialType(): () => void;
export declare function PickType(): () => void;
