...
export declare type OptionProvider<T = any> = Omit<ClassProvider<T>, 'provide'> | Omit<ValueProvider<T>, 'provide'> | Omit<FactoryProvider<T>, 'provide'> | Omit<ExistingProvider<T>, 'provide'> | OptionsProvider;
export declare type ResolverWithOptions = {
    use: Type<I18nResolver>;
} & OptionProvider;
export declare type I18nOptionsWithoutResolvers = Omit<I18nOptions, 'resolvers' | 'loader'>;
export declare type I18nOptionResolver = ResolverWithOptions | Type<I18nResolver> | I18nResolver;
export declare type Formatter = (template: string, ...args: (string | Record<string, string>)[]) => string;
...
export declare type I18nValidatorOptions = ValidatorOptions;
