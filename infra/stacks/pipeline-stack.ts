...
export class PipelineRoleStack extends cdk.Stack {
    constructor(scope: Construct, id: string, props: ApplicationProps) {
        ...
        if (props.githubOrganizationId === undefined) {
            throw new Error('You need add githubOrganizationId in your application props on configs/.');
        }
        ...
        const provider = new iam.OpenIdConnectProvider(this, 'PipelineOidcProvider', {
            url: providerUrl,
