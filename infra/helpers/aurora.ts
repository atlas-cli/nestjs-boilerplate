...
import { addScalingCapacity, createDatabaseCluster } from './create-database-cluster';
...
export const setupAuroraDatabase = (
    ...
    const databaseSecurityGroup = createAndExportGenericSecurityGroup(scope, scopedName + 'DatabaseSecurityGroup', {
    ...
    // Create output
    createOutput(scope, `${scopedName}DatabaseClusterHost`, databaseCluster.clusterEndpoint.hostname);
